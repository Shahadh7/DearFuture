    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900">Create New Capsule</h2>
                    <p class="mt-2 text-gray-600">Send a message to tomorrow</p>
                </div>
                <Link 
...
import CapsuleForm from '@/Pages/Capsules/Partials/CapsuleForm.vue';
</script> 